...
router.get('/', passport.authenticate('bearer', {session:false}),auth.admin, auth.maestro, auth.alumno, auth.required, obtenerResenas);
//Obtener reseña por id
router.get('/:id', passport.authenticate('bearer', {session:false}),auth.admin, auth.maestro, auth.alumno, auth.required, obtenerResena);
